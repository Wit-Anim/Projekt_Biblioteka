...
if(!isset($_SESSION["probyLoginAdmin"]))
{
	$_SESSION["probyLoginAdmin"]=0;
}
?>
<html lang="pl-PL">
<head>
	...
	if($_SESSION["probyLoginAdmin"]<2)
	{
		...
		<div class='tresc'>
			...
			<form action='logowanieAdminBaza.php' method='POST'>
				<br>
				<div class='form'>
						...
						<div class='col-6' style='background-color:rgba(200,173,127,0.8)'>
							<div class='row' id='centrum'>
								...
								<br>
									...
									<div class='row'>
										<div class='col-sm-5'>
										<img src='".$captchaImg."' id='captcha_image'/><br/> <a id='captcha_reload' href='logowanieAdmin.php'>reload</a>
										</div>
